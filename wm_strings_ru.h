...
"function b(checkbox){if(checkbox.checked){var p = g('bs').placeholder;if(p!==''){g('bs').value=p;}}else{g('bs').value=''}}"
...
"<div class='logo-cont'><div class='logo-img'><svg class='pic' alt='логотип' fill='none' height='34' viewBox='0 0 34 34' width='34' xmlns='http://www.w3.org/2000/svg'><circle stroke='dodgerblue' stroke-width='4' r='15.0' cx='17.0' cy='17.0'></circle><rect fill='lightcoral' x='14' y='14' height='6' width='15' ry='3' transform='rotate(-40 17 17)'></svg></div><p class='logo-text'>Config ESP</p></div>";
...
const char HTTP_ROOT_MAIN[]        PROGMEM = "<h3>Настройка модуля</h3>";
...
"button,select,.msg{border-radius:.3rem;width: 100%}input[type=radio],input[type=checkbox]{width: 20px;accent-color: #C038D3;transform: scale(1.5);margin-right:6px;}input{border:0;border-bottom:1px solid #888;padding:5px 0;font-size:1.2em;margin:5px 0;outline:0;width:100%}"
"label{font-size:.9em}"
...
"h3{color:#C038D3;text-align:center;}.pic{animation:5s linear infinite rotate;}"
...
const char S_brand[]              PROGMEM = "Config ESP";
...
const char S_titlewifisaved[]     PROGMEM = "Учетные данные сохранены";
const char S_titlewifisettings[]  PROGMEM = "Настройки сохранены";
const char S_titlewifi[]          PROGMEM = "Настройка устройства";
